...
const isDesigner = (catName) => {
  const name = catName.toLowerCase();
  return name.includes('designer');
};

const DesignerClocks = () => {
  const { 
    products, 
    categories, 
    loading, 
  ...
  // Dynamically resolve the category name from database categories matching 'designer'
  const dbCategoryName = categories.find(isDesigner) || 'Designer Wall Clock';
  ...
  return (
    <div className="bg-[#FCFCFC] py-0 min-h-screen select-none overflow-hidden">
      <SEO 
        title="Designer Wall Clocks | Nilkanth Quartz" 
        description="Explore our exquisite designer wall clocks collection. Creative artistic styles and luxury designs with silent sweep movement to elevate your home interior decor."
      />
        ...
        <div className="max-w-7xl w-full mx-auto px-4 sm:px-8 lg:px-16 flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          ...
          >
            ...
            <p className="text-gray-300 text-xs font-medium uppercase tracking-wider max-w-xl">
              Exquisite masterpieces crafted for luxury spaces, fine home decor, and contemporary style.
            </p>
          </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-1 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <aside className="lg:col-span-3 space-y-6">
            ...
            >
              ...
              <div className="flex flex-col space-y-3 pl-1 pt-2">
                ...
                {categories.map((cat) => {
                  const isSelected = isDesigner(cat);
          ...
          <main className="lg:col-span-9 space-y-8">
            ...
            >
              <p>
                Designer wall clocks are exquisite masterpieces crafted for individuals who appreciate fine art, premium craftsmanship, and exceptional interior decor. Designed to serve as focal points in luxury living rooms, upscale apartments, boutique spaces, and executive offices, these clocks combine artistic elegance with precise timekeeping. Featuring intricate details, creative silhouettes, and premium materials, they make a bold statement on any wall.
              </p>
              <p>
                With their silent sweep quartz movements and stunning design profiles, designer clocks offer a perfect harmony of absolute quietness and aesthetic visual appeal. Whether you prefer contemporary minimalism, glamorous metallics, or abstract creative structures, our designer collection has been carefully curated to suit diverse interior design tastes. Bring sophistication, personal expression, and timeless design to your home with these high-end wall clocks.
              </p>
            </motion.div>
            ...
            <div className="flex justify-center my-6">
              <span className="bg-brand-red text-white px-6 py-2.5 text-xs sm:text-sm font-bold uppercase tracking-widest text-center shadow-md shadow-brand-red/10">
                Designer Wall Clocks Collection
              </span>
            </div>
              ...
              <>
                ...
                {products.length === 0 && (
                  <div className="bg-white border border-[#EEEEEE] rounded-none p-16 text-center space-y-6 shadow-sm">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 uppercase tracking-wider">No Designer Clocks Found</h3>
                    <p className="text-gray-500 text-xs uppercase tracking-wider max-w-xs mx-auto leading-relaxed">
                      We currently do not have any clocks added under the Designer category. Please check back later.
                    </p>
                    <Link
                      to="/products"
