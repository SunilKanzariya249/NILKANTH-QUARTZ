...
const OfficeClocks = () => {
  ...
  // Dynamically resolve the category name from database categories matching 'office'
  const dbCategoryName = categories.find(isOffice) || 'Office Wall Clock';
  ...
  return (
    <div className="bg-[#FCFCFC] py-0 min-h-screen select-none overflow-hidden">
      <SEO 
        title="Office Wall Clocks | Nilkanth Quartz" 
        description="Premium office wall clocks collection. High-visibility, professional designs with silent sweep quartz movement for corporate offices, classrooms, and workspaces."
      />
        ...
        <div className="max-w-7xl w-full mx-auto px-4 sm:px-8 lg:px-16 flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          ...
          >
            ...
            <p className="text-gray-300 text-xs font-medium uppercase tracking-wider max-w-xl">
              High-visibility, minimal, and silent timepieces engineered for administrative environments, classrooms, and workspaces.
            </p>
          </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-1 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <main className="lg:col-span-9 space-y-8">
            ...
            >
              <p>
                Office wall clocks are simple, functional, and highly visible timepieces designed specifically for dynamic workspaces, classrooms, hospitals, and administrative centers. Featuring crisp, bold lettering, high-contrast hands, and silent sweep quartz movements, these clocks provide immediate readability and accurate timekeeping. They foster productivity and efficiency in any environment while maintaining a quiet, distraction-free work atmosphere.
              </p>
              <p>
                Engineered for daily durability and premium professional appeal, our office wall clocks come in a variety of classic round borders, sleek metallic casings, and modern frames. They blend seamlessly with commercial architectural spaces, meeting rooms, study areas, and lobbies. Add a reliable marker of precision, structure, and professional style to your workspace with our high-quality office timepieces.
              </p>
            </motion.div>
              ...
              <>
                ...
                {products.length === 0 && (
                  <div className="bg-white border border-[#EEEEEE] rounded-none p-16 text-center space-y-6 shadow-sm">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 uppercase tracking-wider">No Office Clocks Found</h3>
                    <p className="text-gray-500 text-xs uppercase tracking-wider max-w-xs mx-auto leading-relaxed">
                      We currently do not have any clocks added under the Office category. Please check back later.
                    </p>
                    <Link
                      to="/products"
