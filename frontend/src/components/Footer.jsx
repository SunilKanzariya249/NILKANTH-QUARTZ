...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0D0D0D] text-white border-t border-white/10 pt-16 pb-10">
...
At Nilkanth Quartz, we craft exceptional wall clocks that combine elegant design, precise timekeeping, and enduring quality for spaces that value both style and functionality.            </p>
            <div className="flex items-center gap-3">
              ...
              <a 
                href="https://wa.me/919898693626?text=Hello%20Nilkanth%20Quartz,%20I%20would%20like%20to%20inquire%20about%20your%20wall%20clocks." 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-none border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:border-brand-red hover:bg-brand-red transition-all duration-300"
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm tracking-wider text-gray-400">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+919898693626" className="hover:text-brand-red transition-colors duration-250">
                  +91 98986 93626
                </a>
              </li>
